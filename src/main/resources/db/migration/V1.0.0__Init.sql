...
values (
        ...
        'Thinking Fast and Slow. By winner of Nobel Prize - Danniel Kahneman',
        17.32,
        738,
        '/images/ThinkingFast.jpeg'
    );
...
values (
        ...
        'How to Fail at Almost Everything and Still Win Big - Kind of Story of My Life. By Scott Adams',
        15.00,
        820,
...
values (
        ...
        'Influence',
        'Influence - Psychology of Persuasion. By Robert B. Cialdini Ph.D.',
        99.99,
        1,
        '/images/Influence.jpeg'
    );
...
values (
        ...
        'Poor Charlie''s Almanack - Wits and Wisdom of Charles T. Munger. By Peter Kauffman',
        10.99,
        801,
        '/images/PoorCharlie.jpeg'
    );
...
values (
        ...
        'Hackers & Painters',
        'Hackers & Painters - Big Ideas from Computer Age. By Paul Graham',
        14,
        808,
        '/images/Hackers.jpg'
    );
...
insert into
    ecomm.product
values (
        '3395a42e-2d88-40de-b95f-e00e1502085b',
        'Seeking Wisdom',
        'Seeking Wisdom - From Darwin To Mungar. By Peter Bevelin',
        12,
        127,
        '/images/Seeking.jpg'
    );
...
values (
        ...
        'Thinking In Bets',
        'Thinking In Bets - Making Smarter Decision. When you don''t have all the facts. By Annie Duke',
        18,
        438,
        '/images/ThinkingIn.jpg'
    );
...
values (
        ...
        'Zero to One',
        'Zero to One - Notes on Startups, Or How to build future. Peter Theil',
        15,
        175,
        '/images/ZeroToOne.jpg'
    );
...
insert into
    ecomm.tag (id, name)
values (
        '00000000-b5c6-4896-987c-f30f3678f602',
        'psychology'
    );
...
insert into
    ecomm.tag (id, name)
values (
        '00000000-b5c6-4896-987c-f30f3678f603',
        'influence'
    );
...
insert into
    ecomm.tag (id, name)
values (
        '00000000-b5c6-4896-987c-f30f3678f604',
        'wisdom'
    );
...
insert into
    ecomm.tag (id, name)
values (
        '00000000-b5c6-4896-987c-f30f3678f605',
        'startup'
    );
...
insert into
    ecomm.tag (id, name)
values (
        '00000000-b5c6-4896-987c-f30f3678f606',
        'investing'
    );
...
insert into
    ecomm.tag (id, name)
values (
        '00000000-b5c6-4896-987c-f30f3678f607',
        'lessions'
    );
...
insert into
    ecomm.tag (id, name)
values (
        '00000000-b5c6-4896-987c-f30f3678f608',
        'history'
    );
...
insert into
    ecomm.tag (id, name)
values (
        '00000000-b5c6-4896-987c-f30f3678f609',
        'howto'
    );
...
insert into
    ecomm.tag (id, name)
values (
        '00000000-b5c6-4896-987c-f30f3678f610',
        'journey'
    );
...
insert into
    ecomm.tag (id, name)
values (
        '00000000-b5c6-4896-987c-f30f3678f611',
        'decision'
    );
...
INSERT INTO
    ecomm.card
VALUES (
        '618ffaff-cbcd-48d4-8848-a15601e6725b',
        '999-999-999-999',
        'a1b9b31d-e73c-4112-af7c-b68530f38222',
        'User',
        '12/28',
...
insert into
    ecomm.cart
values (
        'cacab31d-e73c-4112-af7c-b68530f38222',
        'a1b9b31d-e73c-4112-af7c-b68530f38222'
    );
...
insert into
    ecomm.cart
values (
        'cacab31d-e73c-4112-af7c-b68530f38223',
        'a1b9b31d-e73c-4112-af7c-b68530f38223'
    );

insert into
    ecomm.item
values (
        'a7384042-e4aa-4c93-85ae-31a346dad702',
        '6d62d909-f957-430e-8689-b5129c0bb75e',
        1,
        17.15
    );
...
insert into
    ecomm.item
values (
        'a7384042-e4aa-4c93-85ae-31a346dad703',
        'd3588630-ad8e-49df-bbd7-3167f7efb246',
        1,
        10.99
    );
...
INSERT INTO
    ecomm.item
VALUES (
        'a7384042-e4aa-4c93-85ae-31a346dad704',
        '6d62d909-f957-430e-8689-b5129c0bb75e',
        1,
        17.15
    ),
    (
        'a7384042-e4aa-4c93-85ae-31a346dad705',
        '3395a42e-2d88-40de-b95f-e00e1502085b',
        1,
        20.99
    );
...
INSERT INTO
    ecomm.order_item
VALUES (
        '66682caa-a6d8-46ed-a173-ff822f754e1c',
        '0a59ba9f-629e-4445-8129-b9bce1985d6a',
        'a7384042-e4aa-4c93-85ae-31a346dad704'
    ),
    (
        'efeefa71-2760-412a-9ec8-0a040d90f02c',
        '0a59ba9f-629e-4445-8129-b9bce1985d6a',
        'a7384042-e4aa-4c93-85ae-31a346dad705'
    );